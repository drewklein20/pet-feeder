...
# ---- gmail send email ----------
def send_email(emailConfig, petName, cupDuration, trigger, cameraEnabled):
	...
	for toEmail in toEmails:
		...
		if cameraEnabled:
			...
			with open('/var/www/html/php/cam/live.jpg', 'rb') as f:
				...
				mime.add_header('Content-Disposition', 'attachment', filename='live.jpg')
...
def feed():
	...
	if emailNotifications == True:
		print("sending email")
		send_email(emailConfig, petName, cupDuration, trigger, cameraEnabled)
