...
Type in **PetFeeder2021!** for the password at the New password: prompt, and press Enter. Important: The database import will not work unless this is set correctly.
